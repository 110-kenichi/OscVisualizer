...
{
    internal class NeoGeo : IAudioVisualizer
    {
        ...
        private SceneMeshInstance bottomScene;
        ...
        public NeoGeo()
        {
            ...
            // STLファイルパス（適宜変更）
            if (!File.Exists(@"Assets\NEOGEO LOGO_TOP.stl"))
                return;
            ...
            bottomScene = new SceneMeshInstance(bottommesh);
            ...
            _renderer.AddInstance(bottomScene);
        }
        ...
        private void UpdateRotation(float kick, float snare, float hat)
        {
            ...
            topScene.RotationXDeg = currentTopAngleX;
            topScene.RotationYDeg = currentTopAngleY;
        }
