...
{
    internal class PartyParrot : IAudioVisualizer
    {
        public string VisualizerName => "Party Parrot";
        ...
        public PartyParrot()
        {
            var result = PitcureToVectorXYPoints(@"Assets\Party_Parrot.gif", 1f);
        ...
        public List<XYPoint> ProcessAudio(WasapiCapture capture, WaveInEventArgs e)
        {
            ...
            float thetaX = (float)(_sw.Elapsed.TotalSeconds * 0);
            float thetaY = (float)(_sw.Elapsed.TotalSeconds * 0);
            float thetaZ = (float)(_sw.Elapsed.TotalSeconds * 0);
